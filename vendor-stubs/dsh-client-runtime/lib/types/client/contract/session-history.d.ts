import type { RpcError, SessionId } from '@deepseek-ai/dsh-client-connection/client';
...
export interface SessionHistoryFace extends ObservableSnapshot<SessionHistorySnapshot> {
