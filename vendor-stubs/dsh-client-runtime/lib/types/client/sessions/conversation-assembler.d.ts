import type { ConversationEventInput, ConversationNodeDefinition, ConversationPublication, ConversationViewDefinition } from '../contract/conversation.ts';
 ...
 */
export declare class ConversationNodeAssembler {
