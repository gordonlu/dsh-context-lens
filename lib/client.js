	...
	factory: (require) => {
		...
		*/
		...
		function Overview(props) {
			...
			const unstable = lastDropOrdinal > 0 && summary.totalRequests - lastDropOrdinal <= 20;
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(OverviewCard, {
							...
							...!unstable && lastDropOrdinal > 0 ? { meta: t("overview.recovered", { count: String(20) }) } : {},
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(MainStat, {
									...
									value: cache?.deltaPoints === void 0 ? "—" : `${cache.deltaPoints > 0 ? "+" : ""}${Math.round(cache.deltaPoints)}%`,
		...
		*/
		...
		function RequestList(props) {
			...
			const [hideSurface, setHideSurface] = (0, react.useState)(true);
			const ordered = (0, react.useMemo)(() => [...requests].reverse(), [requests]);
			const visible = (0, react.useMemo)(() => ordered.filter((request) => (!hideUnchanged || !isUnchanged(request)) && (!hideSurface || !surfaceOnly(request))), [
				ordered,
				hideUnchanged,
				hideSurface
			]);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
						...
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("list.hideSurface") })]
					}),
		...
		*/
		...
		function ContextView(props) {
			...
			const nodeCountRef = (0, react.useRef)(0);
			(0, react.useEffect)(() => {
			...
			(0, react.useEffect)(() => {
				...
				return () => {
					if (nodeCountRef.current > enterNodes) scroller.scrollTop = scroller.scrollHeight;
				};
			}, []);
